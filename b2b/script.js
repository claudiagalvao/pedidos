...
const vPadrao=variacoes[0];

const preco=vPadrao?.preco || 0;
const estoque=vPadrao?.estoque || 0;

const p10=preco*0.90;
const p12=preco*0.88;
const p15=preco*0.85;
...
<del>Varejo: R$ ${preco.toFixed(2)}</del>
...
Estoque: <span id="estoque-num-${index}">
${estoque}
</span>
</div>
